...
import com.mhd.me_module.contract.icontract.IRegisterContract
import com.mhd.me_module.dispose.MeDispose
import io.reactivex.disposables.Disposable

class RegisterPresenterImpl : BasePresenter<IRegisterContract.View>(), IRegisterContract.Presenter {
...
//        })
    ...
    override fun register(mobile: String, code: String) {
