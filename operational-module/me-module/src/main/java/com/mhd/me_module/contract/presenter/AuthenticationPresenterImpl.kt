...
import com.mhd.me_module.contract.icontract.IAuthenticationContract
import com.mhd.me_module.dispose.MeDispose
import io.reactivex.disposables.Disposable

class AuthenticationPresenterImpl : BasePresenter<IAuthenticationContract.View>(), IAuthenticationContract.Presenter {

    private var meDisposable: Disposable? = null

    override fun auther(mobile: String, code: String) {
