package com.mhd.me_module.dispose;
...
//    Class mRules = GunYunOriginalResultDto.class;//请求结果拦截
     ...
     * @param modelClass
     */
    MeDispose(String mUrl, Class modelClass) {
        this.url = mUrl;
     ...
     */
    MeDispose(String mUrl, Class modelClass, boolean isAuto) {
        this.url = mUrl;
        this.modelClass = modelClass;
        this.isAuto = isAuto;
    }
     ...
     * @param isAuto
     */
    MeDispose(String mUrl, Class modelClass, BaseParams baseParams, boolean isAuto) {
        this.url = mUrl;
        this.modelClass = modelClass;
