...
import com.mhd.me_module.contract.icontract.IChangeNamePwdContract
import io.reactivex.disposables.Disposable

class ChangeNamePresenterImpl : BasePresenter<IChangeNamePwdContract.View>(), IChangeNamePwdContract.Presenter {

    private var meDisposable: Disposable? = null

    override fun changeName(mobile: String, code: String) {
        //配置请求参数
