...
import com.md.me.zone.meaction.viewProxyClick
import com.mhd.basekit.viewkit.mvp.view.BaseMvpFragment
import com.mhd.basekit.viewkit.util.route.RouteConstant
import com.mhd.me_module.R
import com.mhd.me_module.R.*
import com.mhd.me_module.contract.icontract.IMeContract
import com.mhd.me_module.contract.model.MeConfig
import com.mhd.me_module.contract.presenter.MePresenterImpl
import com.mhd.me_module.contract.view.activity.AuthenticationActivity
import com.mhd.me_module.contract.view.activity.LoginActivity
import com.mhd.me_module.contract.view.activity.UserinfoActivity
import com.mhd.me_module.contract.view.assembly.ImageRightTitle
import com.mhd.me_module.databinding.MeFragmentBinding
import com.muheda.mhdsystemkit.sytemUtil.functionutil.IntentToActivity
import org.greenrobot.eventbus.EventBus
import org.greenrobot.eventbus.Subscribe
import org.greenrobot.eventbus.ThreadMode

@Route(path = RouteConstant.me_fragment)
class MeFragment : BaseMvpFragment<MePresenterImpl, MeConfig, MeFragmentBinding>(),
        IMeContract.View, View.OnClickListener {

    override fun getLayoutId(): Int {
        return layout.me_fragment
    }

    override fun creatPresenter(): MePresenterImpl {
        return MePresenterImpl()
    }

    override fun creatConfig(): MeConfig {
        return MeConfig()
    }
...
//                mBinding.ivMeLogin.setImageResource(R.mipmap.loginimg)
    ...
    override fun initImmersionBar() {
        ImmersionBar.with(this).fitsSystemWindows(true).statusBarColor(color.color_FCAC22).init()
    }
}