package com.mhd.home_module.contract.presenter
...
class HomeMainPresenterImpl : BasePresenter<IHomeMainContract.View>(), IHomeMainContract.Presenter {

    private var meDisposable: Disposable? = null

    override fun getData(mobile: String, code: String) {
        //配置请求参数
