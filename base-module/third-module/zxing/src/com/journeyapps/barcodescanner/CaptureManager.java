...
public class CaptureManager {
    ...
    protected void returnResultTimeout() {
        ...
        activity.onResult(Activity.RESULT_CANCELED, "");
        closeAndFinish();
    }
    ...
    protected void returnResult(BarcodeResult rawResult) {
        ...
        IntentResult result = IntentIntegrator.parseActivityResult(REQUEST_CODE, Activity.RESULT_OK, intent);
        if (result.getContents() == null){
            strResult = "";
        }else {
            strResult = result.getContents();
        }
        activity.onResult(Activity.RESULT_OK, strResult);
        closeAndFinish();
    }
