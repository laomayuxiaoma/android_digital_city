...
public class CameraPreview extends ViewGroup {
    ...
    private double marginFraction = 0.15d;
    ...
    protected Rect calculateFramingRect(Rect container, Rect surface) {
        ...
        if (height > intersection.width()){
            intersection.bottom = intersection.top + intersection.width();
            height -= intersection.width();
            intersection.offset(0,height/4);
        }
//        if (intersection.height() > intersection.width()) {
//            // We don't want a frame that is taller than wide.
//            intersection.inset(0, (intersection.height() - intersection.width()) / 2);
//        }
//        intersection.offset(0, -200);
