...
public class SideIndexBar extends View{
    private static final String[] DEFAULT_INDEX_ITEMS = {"历", "史", "A", "B", "C", "D", "E", "F", "G", "H",
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mIndexItems.size(); i++) {
            ...
            canvas.drawText(index,
                    ...
                    ((i == mCurrentIndex) || ((mCurrentIndex == 0 || mCurrentIndex == 1) && (i == 0 || i == 1))) ? mTouchedPaint : mPaint);
        }
    }
                ...
                if (mOnIndexChangedListener != null && touchedIndex >= 0 && touchedIndex < indexSize){
                    if (touchedIndex != mCurrentIndex) {
                        ...
                        if (mOverlayTextView != null){
                            ...
                            String str = mIndexItems.get(touchedIndex);
                            if (touchedIndex == 0 || touchedIndex == 1) {
                                str = mIndexItems.get(0) + mIndexItems.get(1);
                            }
                            mOverlayTextView.setText(str);
                        }
