...
public abstract class CustomFitCenterTransformation extends FitCenter {

    private static final String  ID = "com.muheda.imageloader.formation.CustomFitCenterTransformation";
    private static final byte[]  ID_BYTES = ID.getBytes(CHARSET);

    public CustomFitCenterTransformation() {
        super();
    }
...
//            toTransform.recycle();
    ...
    public boolean equals(Object o) {
        return o instanceof CustomFitCenterTransformation;
    }
