...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIsTextLeft = ta.getBoolean(R.styleable.SlidingTabLayout_tl_isTextLeft, false);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mViewPager.getAdapter() instanceof CustomTabProvider) {
                ...
                if (mIsTextLeft){
                    tabView = View.inflate(mContext, R.layout.layout_tab2, null);
                }else {
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mViewPager.getCurrentItem() != position) {
                    if (!mTitles[position].equals("添加爱车")) {
        ...
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (tv_tab_title != null) {
                ...
                if (mIndicatorStyle == STYLE_TRIANGLE) {
                    tv_tab_title.setBackground(getResources().getDrawable(i == mCurrentTab ? R.drawable.background : R.drawable.otherbackground));
                    tv_tab_title.setPadding(dp2px(15), dp2px(12), dp2px(15), dp2px(12));
                } else {
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                if (mIndicatorStyle == STYLE_TRIANGLE) {
                    tab_title.setBackground(getResources().getDrawable(isSelect ? R.drawable.background : R.drawable.otherbackground));
                }
            }
