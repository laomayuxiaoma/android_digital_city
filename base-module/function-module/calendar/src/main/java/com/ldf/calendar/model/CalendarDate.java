...
public class CalendarDate implements Serializable {
    ...
    public CalendarDate modifyDay(int day) {
        int lastMonthDays = CalendarUtils.getMonthDays(this.year, this.month - 1);
        int currentMonthDays = CalendarUtils.getMonthDays(this.year, this.month);
