...
#function
-keep public class * extends com.example.muheda.functionkit.netkit.model.ModelDto{*;}
#保持所有的内部类不被混淆
-keep class **$**{*;}
-keep public class  com.example.muheda.functionkit.netkit.model.ModelDto{*;}
-keep public class  com.example.muheda.functionkit.netkit.params.BaseParams{*;}
-keep public class * extends com.example.muheda.functionkit.netkit.params.BaseParams{*;}
