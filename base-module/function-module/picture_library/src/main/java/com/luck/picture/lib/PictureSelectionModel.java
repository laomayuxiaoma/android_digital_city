...
public class PictureSelectionModel {
    ...
    public void openExternalPreview(int position, List<LocalMedia> medias) {
        openExternalPreview(position,medias,false);
    }

    public void openExternalPreview(int position, List<LocalMedia> medias,boolean delete) {
        if (selector != null) {
            selector.externalPicturePreview(position, medias,delete);
        } else {
